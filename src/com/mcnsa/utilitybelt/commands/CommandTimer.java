...
@CommandInfo(alias = "@$&#_utility_timer", visible = false)
public class CommandTimer implements Command {
	private static UtilityBelt plugin = null;
	public CommandTimer(UtilityBelt instance) {
		plugin = instance;
	}
	...
	public Boolean handle(Player player, String sArgs) {
		...
		String targetString = "\247b\247d\247c\247b\247d\247cq?=$markerTimer=" + x + "," + y + "," + z;
		
		// get their id
		String idString = "\247b\247d\247c\247b\247d\247cq?=$markerId=" + player.getName() + ".timer";
